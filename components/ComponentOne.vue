...
<script setup>
import { ref } from 'vue';
import ComponentFive from './ComponentFive.vue'; // Sepet bileşenini import edin

const cartStore = useCartStore();
// Ürün sayısı hesaplama (quantity toplanarak)
const totalItemCount = computed(() => {
  // EĞER store'da 'cartItems' var ise:
...
.tus{
  position: absolute;
                      top: -10px; /* Butonun üst kısmından uzaklığı */
                      right: 0px; /* Sağ kenardan uzaklığı */
                      background-color: #e42437;
                      color: white;
                      font-size: 12px;
                      width: 20px;
...
.header-sag-taraf-container>button{
  height: 42px;
  color: #56008e;
  background-color: #56008e;
  border-radius: 4px;
