  ...
  <div class="orta-banner-container">
    <div class="orta-banner-icerik">
      ...
      <div class="orta-banner-ust-kisim">
        <div class="zoom-container" v-if="resimler[0]">
          <img :src="resimler[0].resim" alt="Image 1" />
        </div>
      ...
      <div class="orta-banner-alt-kisim" v-if="resimler[1]">
        <img :src="resimler[1].resim" alt="Image 4" />
      </div>
    </div>
  </div>
</template>
